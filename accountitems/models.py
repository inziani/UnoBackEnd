...
class GLDocument(models.Model):
    ...
    amountInDocumentCurrency = models.DecimalField(decimal_places=2, max_digits=15)
    taxCode = models.ForeignKey(TaxCode, max_length=2, null=False, blank=False, related_name='taxCode_GLDocument', on_delete=PROTECT)
    taxAmountInDocumentCurrency = models.DecimalField(decimal_places=2, max_digits=15)
...
class GLAccountLineItems(models.Model):
    ...
    amountInLocalCurrency = models.DecimalField(decimal_places=2, max_digits=15)
    taxCode = models.CharField(max_length=2, null=False, blank=False)
    taxAmountLocalCurrency = models.DecimalField(decimal_places=2, max_digits=15)
    amountInForeignCurrency = models.DecimalField(decimal_places=2, max_digits=15)
    taxAmountForeignCurrency = models.DecimalField(decimal_places=2, max_digits=15)
