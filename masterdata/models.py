...
class GeneralLedgerAccountMaster(models.Model):
    ...
    accountGroup = models.CharField(null=True, blank=True, max_length=4)
    accountType = models.CharField(choices=ACCOUNTTYPE, null=False, blank=True, max_length=30)
    reconciliationAccountInput = models.BooleanField(null=True, blank=True)
    ...
    balancesInLocalCurrency = models.BooleanField(null=True, blank=True)
    exchangeRateKey = models.CharField(max_length=3, null=True, blank=True)
    taxCategory = models.CharField(max_length=2, null=True, blank=True)
    postingWithoutTaxAllowed = models.BooleanField(null=True, blank=True)
    openItemManagement = models.BooleanField(null=True, blank=True)
    lineItemManagement = models.BooleanField(null=True, blank=True)
    blockedForPosting = models.BooleanField(null=True, blank=True)
    markedForDeletion = models.BooleanField(null=True, blank=True)
    groupAccountNumber = models.IntegerField(null=True, blank=True, unique=False, default=0)
    tradingPartner = models.IntegerField(null=True, blank=True, unique=False, default=None)
    sortKey = models.CharField(null=True, blank=True, max_length=2)
    authorizationGroup = models.CharField(null=True, blank=True, max_length=4)
    fieldStatusGroup = models.CharField(null=True, blank=True, max_length=4)
    postAutomaticallyOnly = models.BooleanField(null=True, blank=True)
    relevantToCashFlow = models.BooleanField(null=True, blank=True)
    houseBank = models.CharField(null=True, blank=True, max_length=4)
    houseBankAccountID = models.IntegerField(null=True, blank=True, unique=False, default=0)
    controllingArea = models.ForeignKey(ControllingArea, max_length=4, null=True, blank=True, related_name='GeneralLedgerAccountMaster', on_delete=PROTECT)
    costElement = models.IntegerField(null=True, blank=True, unique=False, default=0)
    unitOfMeasure = models.CharField(null=True, blank=True, max_length=5)
    businessArea = models.ForeignKey(BusinessArea, max_length=4, null=True, blank=True, related_name='GeneralLedgerAccountMaster', on_delete=PROTECT)
    valuationGroup = models.CharField(null=True, blank=True, max_length=5)
    inflationKey = models.CharField(null=True, blank=True, max_length=2)
    toleranceGroup = models.CharField(null=True, blank=True, max_length=5)
    planningLevel = models.CharField(null=True, blank=True, max_length=2)
    supplementAutomaticPostings = models.BooleanField(null=True, blank=True)
    dateCreated = models.DateTimeField(auto_now_add=True)
    dateChanged = models.DateTimeField(auto_now=True)
